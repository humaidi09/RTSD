          ...
          >
            {filter === cat && (
              <motion.span
                ...
                className="absolute inset-0 -z-10 rounded-full bg-gradient-to-r from-neonCyan to-neonPurple"
            ...
            return (
              ...
              >
                <SpotlightCard accent={accent} className="flex h-full flex-col">
                  ...
                  >
                    {/* Banner */}
                    <div className="code-surface relative flex min-h-28 items-end overflow-hidden bg-[#0b1120] p-6">
        ...
        >
          ...
          >
            ...
            <div className="min-h-0 flex-1 overflow-y-auto p-6">
              ...
              <h4 className="mt-6 flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-neonCyan">
                Architecture
              </h4>
              <p className="mt-2 leading-relaxed text-ink/90">{project.details}</p>

              <h4 className="mt-6 font-mono text-xs uppercase tracking-wider text-neonCyan">Tech stack</h4>
            ...
            <div className="flex flex-wrap items-center gap-3 border-t border-hair p-6">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-neonCyan to-neonPurple px-5 py-2.5 font-semibold text-void transition-transform duration-200 hover:scale-[1.02]"
              >
