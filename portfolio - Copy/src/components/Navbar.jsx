  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 top-0 z-[60] h-[3px] bg-transparent" aria-hidden="true">
        <div
          className="h-full origin-left bg-gradient-to-r from-neonCyan via-neonPurple to-neon-magenta"
      ...
      <header className={`fixed inset-x-0 top-0 z-50 px-4 transition-all duration-300 ${scrolled ? 'pt-3' : 'pt-5'}`}>
        <nav
          className={`mx-auto flex max-w-6xl items-center justify-between gap-4 rounded-2xl px-4 backdrop-blur-xl transition-all duration-300 sm:px-5 ${
            scrolled
              ? 'glass-strong border-b border-hair py-2.5 shadow-xl shadow-black/40'
              : 'border border-transparent py-2'
          }`}
        >
          <a href="#top" className="flex items-center gap-2.5 font-mono text-sm font-semibold">
            <span className="rounded-full bg-gradient-to-br from-neonCyan via-neonPurple to-neon-magenta p-[1.5px] shadow-[0_0_16px_-4px_rgba(6,182,212,0.6)]">
              <img
          ...
          <div className="hidden items-center gap-2 lg:flex">
            ...
            <a
              href="#contact"
              className="rounded-lg bg-gradient-to-r from-neonCyan to-neonPurple px-4 py-2 text-sm font-semibold text-void transition-transform duration-200 hover:scale-[1.03]"
            >
              Let&rsquo;s talk
            </a>
          </div>
            ...
            >
              <div className="flex items-center justify-between">
                <span className="flex items-center gap-2 font-mono text-sm font-semibold text-ink">
                  <span className="rounded-full bg-gradient-to-br from-neonCyan via-neonPurple to-neon-magenta p-[1.5px]">
                    <img
                      src={personalInfo.photo}
                      alt={personalInfo.name}
              ...
              <a
                href="#contact"
                onClick={() => setOpen(false)}
                className="mt-4 block rounded-xl bg-gradient-to-r from-neonCyan to-neonPurple px-4 py-3 text-center text-sm font-semibold text-void"
              >
                Let&rsquo;s talk
              </a>
