...
export default function Footer() {
  const year = 2026 // portfolio launch year
  ...
  return (
    <footer className="relative mt-10 border-t border-hair">
      ...
      <button
        ...
        className="group absolute -top-5 right-4 grid h-11 w-11 place-items-center rounded-full border border-hair bg-gradient-to-br from-neonCyan to-neonPurple text-void shadow-lg shadow-black/40 transition-transform duration-200 hover:-translate-y-0.5 hover:scale-105 sm:right-6"
      >
